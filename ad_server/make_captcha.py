...
"""
    ...
    Modified from: https://github.com/lepture/captcha/master/captcha/image.py
"""
...
FONTS_DIR = 'ttf'
font_paths = [os.path.join(FONTS_DIR, file) for file in os.listdir(FONTS_DIR)][-2:]
image_captcha = ImageCaptcha(width=300, fonts=font_paths)

if __name__ == '__main__':
    data = image_captcha.generate('1234')
    image_captcha.write('DosaYummy', 'out.png')