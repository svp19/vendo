...
import com.alphawallet.app.ui.NewUploadAdFragment;
...
public abstract class BuildersModule {
	...
	@FragmentScope
	@ContributesAndroidInjector(modules = NewUploadAdModule.class)
	abstract NewUploadAdFragment bindUploadAdFragment();
