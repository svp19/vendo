        ...
        FragmentMessenger, Runnable, SignAuthenticationCallback, LifecycleObserver, PagerCallback
{
    ...
    private final Fragment uploadAdFragment;
    ...
    public HomeActivity()
    {
        ...
        uploadAdFragment = new NewUploadAdFragment();
    ...
    private void showPage(WalletPage page)
    {
        ...
        switch (page)
        {
            ...
            {
                hideToolbar();
                viewPager.setCurrentItem(UPLOAD_AD.ordinal());
                setTitle(getString(R.string.toolbar_header_upload));
                selectNavigationItem(UPLOAD_AD);
