...
import static com.alphawallet.app.entity.WalletPage.UPLOAD_AD;
...
public class AWalletBottomNavigationView extends LinearLayout {
    ...
    private final ImageView uploadAd;
    ...
    private final TextView uploadAdLabel;
    ...
    public AWalletBottomNavigationView(Context context, @Nullable AttributeSet attrs) {
        ...
        uploadAd = findViewById(R.id.nav_upload);
        ...
        uploadAdLabel = findViewById(R.id.nav_upload_text);
        ...
        findViewById(R.id.upload_tab).setOnClickListener(v -> selectItem(UPLOAD_AD));
        ...
        uploadAd.setOnClickListener(v -> selectItem(UPLOAD_AD));
        ...
        uploadAdLabel.setOnClickListener(v -> selectItem(UPLOAD_AD));
    ...
    public void setSelectedItem(WalletPage index) {
        ...
        switch (index) {
            ...
            case ACTIVITY:
                ...
                break;
            case UPLOAD_AD:
                uploadAd.setImageResource(R.drawable.ic_tab_upload_active);
                activityLabel.setTextColor(getResources().getColor(R.color.colorHighlight, getContext().getTheme()));
                break;
        }
    }
    ...
    private void deselectAll() {
        ...
        uploadAd.setImageResource(R.drawable.ic_tab_upload);
        //reset text colour
        ...
        uploadAdLabel.setTextColor(getContext().getColor(R.color.dove));
    }
